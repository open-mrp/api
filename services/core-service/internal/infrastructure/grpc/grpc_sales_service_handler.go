...
func salesOrderLineToProto(l *domain.SalesOrderLine) *pb.SalesOrderLineInfo {
	...
	info := &pb.SalesOrderLineInfo{
		...
		PricingQuantityRatioNumerator:        l.PricingQuantityRatioNumerator,
		PricingQuantityRatioDenominator:      l.PricingQuantityRatioDenominator,
		PricingPriceRatioNumerator:           l.PricingPriceRatioNumerator,
		PricingPriceRatioDenominator:         l.PricingPriceRatioDenominator,
		PricingUnavailable:                   l.PricingQuantityRatioNumerator == "",
