...
type APIKeyGenConfig struct {
	// SecretKeyStrength (optional; default: KeyStrengthHigh) controls the length of the generated secret portion of the key.
	SecretKeyStrength KeyStrength

	// IDKeyStrength (optional; default: KeyStrengthLow) controls the length of the generated ID portion of the key.
