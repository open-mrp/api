...
const (
	...
	// ObjectTypePromiseDateQuote indicates that the object is the earliest date the plan could ship a quantity.
	ObjectTypePromiseDateQuote ObjectType = "promise_date_quote"
