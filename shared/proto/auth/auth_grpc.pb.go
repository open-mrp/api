...
func (c *authServiceClient) BatchGetAPIKeysByIDs(ctx context.Context, in *BatchGetAPIKeysByIDsRequest, opts ...grpc.CallOption) (*BatchGetAPIKeysByIDsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BatchGetAPIKeysByIDsResponse)
	err := c.cc.Invoke(ctx, AuthService_BatchGetAPIKeysByIDs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServiceServer) BatchGetAPIKeysByIDs(context.Context, *BatchGetAPIKeysByIDsRequest) (*BatchGetAPIKeysByIDsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BatchGetAPIKeysByIDs not implemented")
}
...
func _AuthService_BatchGetAPIKeysByIDs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchGetAPIKeysByIDsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).BatchGetAPIKeysByIDs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_BatchGetAPIKeysByIDs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).BatchGetAPIKeysByIDs(ctx, req.(*BatchGetAPIKeysByIDsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
