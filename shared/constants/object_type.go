...
const (
	...
	ObjectTypeCheckoutSalesOrderResponse ObjectType = "checkout_sales_order_response"
	// ObjectTypeCreateProductionRunResponse indicates that the object is a create production run response.
	ObjectTypeCreateProductionRunResponse ObjectType = "create_production_run_response"
