...
var outboxRepoTracer = tracing.GetTracer("api-gateway.outbox_repository")
...
func (r *outboxRepoImpl) Create(ctx context.Context, input messaging.OutboxMessageInput) (int64, error) {
	// No tracing - this is called from async background goroutines
...
// NewOutboxEnqueuerRepo creates a new outbox enqueuer repository.
