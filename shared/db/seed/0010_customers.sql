...
-- role_id is the global Customer role (constants.GlobalCustomerRoleID). Without it this user has no permissions and internal-own-account reads (e.g. messaging:read for the notifications unread-count) 403.
