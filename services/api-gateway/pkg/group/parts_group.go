...
import (
	...
	partep "github.com/open-mrp/api/services/api-gateway/endpoints/parts"
...
func (*PartsEndpointGroup) Materialize(config *PartsEndpointGroupConfig) *PartsEndpointGroup {
	...
	bulkUpsertPartsEndpoint := apiendpoint.From(&partep.BulkUpsertPartsEndpoint{}).WithService(inner, partSvc)
