...
// Returns nil when no includes were set (meaning: fetch everything for backward compat).
...
// When no includes are in the context (nil), returns true for backward compatibility —
// callers that don't set includes get all data.
