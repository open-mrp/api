...
const (
	...
	RoleTypeCodeCustom RoleTypeCode = "user" // TODO: Should update to "custom" in DB and app code
...
func (m RoleTypeCode) IsValid() bool {
	switch m {
	case RoleTypeCodeAdmin, RoleTypeCodeCustom, RoleTypeCodeScanner, RoleTypeCodeSalesRep:
		return true
	default:
		return false
	}
...
func (m RoleTypeCode) EnumValues() []string {
	return []string{string(RoleTypeCodeAdmin), string(RoleTypeCodeCustom), string(RoleTypeCodeScanner), string(RoleTypeCodeSalesRep)}
}
