...
const (
	...
	// ObjectTypeCommitment indicates that the object is a commitment (ship-by date and its derivation) sub-resource.
	ObjectTypeCommitment ObjectType = "commitment"
	...
	// ObjectTypeAnalyzeSalesBreakdownResponse indicates that the object is an invoiced-sales analysis.
	ObjectTypeAnalyzeSalesBreakdownResponse ObjectType = "analyze_sales_breakdown_response"
	// ObjectTypeSalesTotals indicates that the object is invoiced sales totals for one window or period.
	ObjectTypeSalesTotals ObjectType = "sales_totals"
	// ObjectTypeSalesBreakdown indicates that the object is invoiced sales totals for one slice of the order book.
	ObjectTypeSalesBreakdown ObjectType = "sales_breakdown"
	...
	// ObjectTypeDeliveryRelated indicates that the object names the records a delivery sits between.
	ObjectTypeDeliveryRelated ObjectType = "delivery_related"
	...
	// ObjectTypeEmailSender indicates that the object is the outbound identity an account's merchant-facing mail sends as.
	ObjectTypeEmailSender ObjectType = "email_sender"
	...
	// ObjectTypePurchaseOrderRelated indicates that the object names the records produced from a purchase order.
	ObjectTypePurchaseOrderRelated ObjectType = "purchase_order_related"
	...
	// ObjectTypeReceivingOrderTotals indicates that the object is a receiving order's aggregated totals.
	ObjectTypeReceivingOrderTotals ObjectType = "receiving_order_totals"
	// ObjectTypeReceivingOrderStageTotal indicates that the object is one stage of a receiving order's totals.
	ObjectTypeReceivingOrderStageTotal ObjectType = "receiving_order_stage_total"
	// ObjectTypeReceivingOrderRelated indicates that the object names the records a receiving order sits between.
	ObjectTypeReceivingOrderRelated ObjectType = "receiving_order_related"
	...
	// ObjectTypeItemCostRate indicates that the object is one line of an item's cost breakdown.
	ObjectTypeItemCostRate ObjectType = "item_cost_rate"
	// ObjectTypeItemCosts indicates that the object is an item's per-unit cost breakdown.
	ObjectTypeItemCosts ObjectType = "item_costs"
	// ObjectTypeItemTrends indicates that the object is an item's trend series.
	ObjectTypeItemTrends ObjectType = "item_trends"
	// ObjectTypeReconciledItemResult indicates that the object is a reconciled row of a bulk inventory reconcile.
	ObjectTypeReconciledItemResult ObjectType = "reconciled_item_result"
	// ObjectTypeSkippedItemResult indicates that the object is a skipped row of a bulk inventory reconcile.
	ObjectTypeSkippedItemResult ObjectType = "skipped_item_result"
	// ObjectTypeReconcileErrorResult indicates that the object is a failed row of a bulk inventory reconcile.
	ObjectTypeReconcileErrorResult ObjectType = "reconcile_error_result"
