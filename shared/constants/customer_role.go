...
// type). Its permissions define what a customer may do on the portal. Both the
// customer registration flow and cmd/backfill-customer-role reference these
// constants; the row itself is created in production by the backfill command and
