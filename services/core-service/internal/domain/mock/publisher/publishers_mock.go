...
// Source: /Users/liam/Documents/Seller Co/Augno/api/services/core-service/internal/domain/publishers.go
//
// Generated by this command:
//
//	mockgen -source=/Users/liam/Documents/Seller Co/Augno/api/services/core-service/internal/domain/publishers.go -destination=/Users/liam/Documents/Seller Co/Augno/api/services/core-service/internal/domain/mock/publisher/publishers_mock.go -package=publishermock
//
...
func (m *MockBillingPublisher) PublishReportInvoiceCreated(ctx context.Context, accountID, invoiceID string) *apierror.APIError {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PublishReportInvoiceCreated", ctx, accountID, invoiceID)
	ret0, _ := ret[0].(*apierror.APIError)
	return ret0
}

// PublishReportInvoiceCreated indicates an expected call of PublishReportInvoiceCreated.
func (mr *MockBillingPublisherMockRecorder) PublishReportInvoiceCreated(ctx, accountID, invoiceID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PublishReportInvoiceCreated", reflect.TypeOf((*MockBillingPublisher)(nil).PublishReportInvoiceCreated), ctx, accountID, invoiceID)
}
...
type MockProductionScheduleEnqueuer struct {
	ctrl     *gomock.Controller
	recorder *MockProductionScheduleEnqueuerMockRecorder
	isgomock struct{}
}

// MockProductionScheduleEnqueuerMockRecorder is the mock recorder for MockProductionScheduleEnqueuer.
type MockProductionScheduleEnqueuerMockRecorder struct {
	mock *MockProductionScheduleEnqueuer
}

// NewMockProductionScheduleEnqueuer creates a new mock instance.
func NewMockProductionScheduleEnqueuer(ctrl *gomock.Controller) *MockProductionScheduleEnqueuer {
	mock := &MockProductionScheduleEnqueuer{ctrl: ctrl}
	mock.recorder = &MockProductionScheduleEnqueuerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockProductionScheduleEnqueuer) EXPECT() *MockProductionScheduleEnqueuerMockRecorder {
	return m.recorder
}

// EnqueueGeneration mocks base method.
func (m *MockProductionScheduleEnqueuer) EnqueueGeneration(ctx context.Context, params domain.EnqueueGenerationParams) *apierror.APIError {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EnqueueGeneration", ctx, params)
	ret0, _ := ret[0].(*apierror.APIError)
	return ret0
}

// EnqueueGeneration indicates an expected call of EnqueueGeneration.
func (mr *MockProductionScheduleEnqueuerMockRecorder) EnqueueGeneration(ctx, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EnqueueGeneration", reflect.TypeOf((*MockProductionScheduleEnqueuer)(nil).EnqueueGeneration), ctx, params)
}
