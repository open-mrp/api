...
const file_agent_agent_proto_rawDesc = "" +
	...
	"\x05alert\x18\x01 \x01(\v2\x15.agent.AgentAlertInfoR\x05alert2\xa0\x0e\n" +
	"\fAgentService\x12A\n" +
	"\n" +
	...
	"\x11DeleteAgentMemory\x12\x1f.agent.DeleteAgentMemoryRequest\x1a .agent.DeleteAgentMemoryResponse\x12P\n" +
...
var file_agent_agent_proto_goTypes = []any{
	...
	(*DeleteAgentMemoryResponse)(nil),        // 49: agent.DeleteAgentMemoryResponse
	(*AgentAlertInfo)(nil),                   // 50: agent.AgentAlertInfo
	(*ListAgentAlertsRequest)(nil),           // 51: agent.ListAgentAlertsRequest
	(*ListAgentAlertsResponse)(nil),          // 52: agent.ListAgentAlertsResponse
	(*GetAgentAlertRequest)(nil),             // 53: agent.GetAgentAlertRequest
	(*GetAgentAlertResponse)(nil),            // 54: agent.GetAgentAlertResponse
	(*AcknowledgeAgentAlertRequest)(nil),     // 55: agent.AcknowledgeAgentAlertRequest
	(*AcknowledgeAgentAlertResponse)(nil),    // 56: agent.AcknowledgeAgentAlertResponse
}
var file_agent_agent_proto_depIdxs = []int32{
	...
	50, // 25: agent.ListAgentAlertsResponse.alerts:type_name -> agent.AgentAlertInfo
	26, // 26: agent.ListAgentAlertsResponse.page_info:type_name -> agent.PageInfo
	50, // 27: agent.GetAgentAlertResponse.alert:type_name -> agent.AgentAlertInfo
	50, // 28: agent.AcknowledgeAgentAlertResponse.alert:type_name -> agent.AgentAlertInfo
	0,  // 29: agent.AgentService.TriggerRun:input_type -> agent.TriggerRunRequest
	2,  // 30: agent.AgentService.GetRunStatus:input_type -> agent.GetRunStatusRequest
	4,  // 31: agent.AgentService.CancelRun:input_type -> agent.CancelRunRequest
	7,  // 32: agent.AgentService.CreateCustomAgent:input_type -> agent.CreateCustomAgentRequest
	9,  // 33: agent.AgentService.UpdateCustomAgent:input_type -> agent.UpdateCustomAgentRequest
	11, // 34: agent.AgentService.DeleteCustomAgent:input_type -> agent.DeleteCustomAgentRequest
	13, // 35: agent.AgentService.GetAgentDefinition:input_type -> agent.GetAgentDefinitionRequest
	15, // 36: agent.AgentService.ListAgentDefinitions:input_type -> agent.ListAgentDefinitionsRequest
	17, // 37: agent.AgentService.ListAvailableTools:input_type -> agent.ListAvailableToolsRequest
	19, // 38: agent.AgentService.UpdateAgentAccountStatus:input_type -> agent.UpdateAgentAccountStatusRequest
	30, // 39: agent.AgentService.GetRun:input_type -> agent.GetRunRequest
	32, // 40: agent.AgentService.ListRuns:input_type -> agent.ListRunsRequest
	34, // 41: agent.AgentService.ContinueRun:input_type -> agent.ContinueRunRequest
	36, // 42: agent.AgentService.ListTokenUsage:input_type -> agent.ListTokenUsageRequest
	40, // 43: agent.AgentService.ListAgentMemories:input_type -> agent.ListAgentMemoriesRequest
	42, // 44: agent.AgentService.GetAgentMemory:input_type -> agent.GetAgentMemoryRequest
	44, // 45: agent.AgentService.CreateAgentMemory:input_type -> agent.CreateAgentMemoryRequest
	46, // 46: agent.AgentService.UpdateAgentMemory:input_type -> agent.UpdateAgentMemoryRequest
	48, // 47: agent.AgentService.DeleteAgentMemory:input_type -> agent.DeleteAgentMemoryRequest
	51, // 48: agent.AgentService.ListAgentAlerts:input_type -> agent.ListAgentAlertsRequest
	53, // 49: agent.AgentService.GetAgentAlert:input_type -> agent.GetAgentAlertRequest
	55, // 50: agent.AgentService.AcknowledgeAgentAlert:input_type -> agent.AcknowledgeAgentAlertRequest
	1,  // 51: agent.AgentService.TriggerRun:output_type -> agent.TriggerRunResponse
	3,  // 52: agent.AgentService.GetRunStatus:output_type -> agent.GetRunStatusResponse
	5,  // 53: agent.AgentService.CancelRun:output_type -> agent.CancelRunResponse
	8,  // 54: agent.AgentService.CreateCustomAgent:output_type -> agent.CreateCustomAgentResponse
	10, // 55: agent.AgentService.UpdateCustomAgent:output_type -> agent.UpdateCustomAgentResponse
	12, // 56: agent.AgentService.DeleteCustomAgent:output_type -> agent.DeleteCustomAgentResponse
	14, // 57: agent.AgentService.GetAgentDefinition:output_type -> agent.GetAgentDefinitionResponse
	16, // 58: agent.AgentService.ListAgentDefinitions:output_type -> agent.ListAgentDefinitionsResponse
	18, // 59: agent.AgentService.ListAvailableTools:output_type -> agent.ListAvailableToolsResponse
	20, // 60: agent.AgentService.UpdateAgentAccountStatus:output_type -> agent.UpdateAgentAccountStatusResponse
	31, // 61: agent.AgentService.GetRun:output_type -> agent.GetRunResponse
	33, // 62: agent.AgentService.ListRuns:output_type -> agent.ListRunsResponse
	35, // 63: agent.AgentService.ContinueRun:output_type -> agent.ContinueRunResponse
	38, // 64: agent.AgentService.ListTokenUsage:output_type -> agent.ListTokenUsageResponse
	41, // 65: agent.AgentService.ListAgentMemories:output_type -> agent.ListAgentMemoriesResponse
	43, // 66: agent.AgentService.GetAgentMemory:output_type -> agent.GetAgentMemoryResponse
	45, // 67: agent.AgentService.CreateAgentMemory:output_type -> agent.CreateAgentMemoryResponse
	47, // 68: agent.AgentService.UpdateAgentMemory:output_type -> agent.UpdateAgentMemoryResponse
	49, // 69: agent.AgentService.DeleteAgentMemory:output_type -> agent.DeleteAgentMemoryResponse
	52, // 70: agent.AgentService.ListAgentAlerts:output_type -> agent.ListAgentAlertsResponse
	54, // 71: agent.AgentService.GetAgentAlert:output_type -> agent.GetAgentAlertResponse
	56, // 72: agent.AgentService.AcknowledgeAgentAlert:output_type -> agent.AcknowledgeAgentAlertResponse
