...
//
// We DO NOT emit a stub Account containing just {id, object}. The Account schema declares name/created_at/updated_at as required, and a stub would fail OpenAPI validation. More importantly: any field on a stub would be "hallucinated" (not loaded from the DB), which violates the framework's no-hallucination rule.
