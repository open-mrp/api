...
CREATE TABLE `account` (
  `id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `account_type_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `onboarding_status_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `account_billing_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `default_billing_address_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `default_shipping_address_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `account_plan_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `internal_stripe_customer_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `internal_stripe_subscription_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `account_billing` (
  ...
  `account_plan_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `internal_stripe_customer_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `internal_stripe_subscription_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `subscription_status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `subscription_current_period_end` datetime(3) DEFAULT NULL,
  `stripe_billing_profile_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `stripe_billing_cadence_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `stripe_pricing_plan_subscription_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `servicing_status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `collection_status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `account_branding` (
  ...
  `logo_url` varchar(2083) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phone_number` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `facebook_handle` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `instagram_handle` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `linkedin_handle` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `twitter_handle` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `website_url` varchar(2083) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  PRIMARY KEY (`id`),
...
CREATE TABLE `account_group` (
  ...
  `commission_status_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `freight_status_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `account_group_type_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `registration_flow_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  PRIMARY KEY (`id`),
...
CREATE TABLE `account_group_product_line` (
  `id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `account_group_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_line_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  PRIMARY KEY (`id`),
...
CREATE TABLE `account_group_quantity_discount` (
  `id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `account_group_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `quantity_discount_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  PRIMARY KEY (`id`),
...
CREATE TABLE `account_integration` (
  `id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `integration_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `credentials_v2` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `account_inventory_setting` (
  `id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `inventory_policy_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  PRIMARY KEY (`id`),
...
CREATE TABLE `account_plan` (
  ...
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `plan_type_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `version` int NOT NULL DEFAULT '1',
  `price_per_seat` decimal(10,2) NOT NULL,
  `price_per_month` decimal(10,2) DEFAULT NULL,
  `seat_minimum` int DEFAULT NULL,
  `stripe_pricing_plan_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `registration_limit` int DEFAULT NULL,
  `display_features` json NOT NULL,
  `display_order` int NOT NULL DEFAULT '0',
  `is_highlighted` tinyint(1) NOT NULL DEFAULT '0',
  `button_text` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Get Started',
  `includes_previous_plan` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `account_price` (
  ...
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `owner_account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `unit_value_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_line_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `recipient_account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `account_price_attribute` (
  `id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `account_price_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `account_relation` (
  ...
  `account_relation_role_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `external_number` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `hubspot_company_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `notes` text COLLATE utf8mb4_unicode_ci,
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `parent_account_relation_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `alias` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `default_billing_address_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `default_shipping_address_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `commission_status_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `freight_status_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `default_carrier_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `default_carrier_option_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `default_sales_rep_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `account_status_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `credit_limit_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `account_relation_notification_preference` (
  `id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `account_relation_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `account_user` (
  ...
  `status_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
...
CREATE TABLE `address` (
  ...
  `geolocation_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  PRIMARY KEY (`id`),
...
CREATE TABLE `agent_token_billing` (
  ...
  `stripe_metered_item_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `run_count` int NOT NULL DEFAULT '0',
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  PRIMARY KEY (`id`),
  UNIQUE KEY `agent_token_billing_account_id_period_start_key` (`account_id`,`period_start`),
  KEY `agent_token_billing_account_id_idx` (`account_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `audit_event` (
  ...
  `actor_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `actor_type` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `identity_type` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `source_ip` varchar(46) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `batch` (
  ...
  `quantity_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `scanning_station_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `seconds_quantity_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `waste_quantity_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `production_step_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `production_run_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `change_log` (
  ...
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `action_type_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `responsible_user_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `color` (
  `id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `dark_hex` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `light_hex` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  PRIMARY KEY (`id`),
...
CREATE TABLE `consumption` (
  ...
  `quantity_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `production_step_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `waste_quantity_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `delivery` (
  ...
  `account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `delivery_status_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `delivery_line` (
  ...
  `receiving_order_line_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `quantity_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `email_log` (
  ...
  `account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sent_by_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
...
CREATE TABLE `email_recipient` (
  ...
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `email_log_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `error_log` (
  `id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `affected_user_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `api_location_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `public_message` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `private_message` text COLLATE utf8mb4_unicode_ci,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `error_severity_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `location_file` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `location_method` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `account_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `geolocation` (
  `id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `street_line_1` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `google_place_id` varchar(767) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
...
CREATE TABLE `hubspot_account_user_link` (
  ...
  `hubspot_contact_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `owner_account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `customer_account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `idempotency_key` (
  ...
  `target_account_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `request_body_hash` char(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `scope_hash` char(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `request_params` json DEFAULT NULL,
  `response_code` int DEFAULT NULL,
  `response_body` json DEFAULT NULL,
  `response_headers` json DEFAULT NULL,
  `recovery_point` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `inventory_allocation` (
  `id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `inventory_receipt_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `inventory_issue_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `quantity_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `unit_cost_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `total_cost_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  PRIMARY KEY (`id`),
...
CREATE TABLE `inventory_change_log` (
  ...
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `inventory_log_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `responsible_user_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `inventory_receipt` (
  `id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `owner_account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `holder_account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `item_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `storage_location_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lot_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `invoice` (
  ...
  KEY `invoice_account_id_idx` (`account_id`),
...
CREATE TABLE `item` (
  ...
  `deleted_at` datetime(3) DEFAULT NULL,
  `unit_value_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `burn_rate_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `item_type_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `unit_cost_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `item_category_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `item_category` (
  ...
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `account_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `item_category_type_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `unit_group_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `journal_posting` (
  `id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `account_transaction_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `posting_side_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `amount_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  PRIMARY KEY (`id`),
...
CREATE TABLE `material` (
  ...
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `item_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_point_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `lead_time_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `message_inbox` (
  ...
  `handler` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `message_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `request_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `parent_message_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `order_discount` (
  ...
  `discount_type_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  PRIMARY KEY (`id`),
...
CREATE TABLE `permission` (
  ...
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `permission_group_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `pick_line` (
  `id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `pick_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `quantity_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sales_order_line_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
...
CREATE TABLE `product` (
  ...
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `item_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_type_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_line_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `product_line_target` (
  ...
  `product_line_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sales_rep_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `amount_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
...
CREATE TABLE `production_run` (
  `id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `responsible_user_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `number` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `production_step` (
  ...
  `labor_rate_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `labor_time_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `leveling_factor` decimal(65,30) NOT NULL DEFAULT '0.000000000000000000000000000000',
  `overhead_rate_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `department_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `quantity_discount_tier` (
  ...
  `parent_tier_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `quantity_discount_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `rate` (
  ...
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `numerator_unit_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `denominator_unit_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `receiving_order_line` (
  `id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `receiving_order_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `quantity_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sales_order_line_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
...
CREATE TABLE `registration_session` (
  ...
  `plan_code` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  KEY `registration_session_verification_token_idx` (`verification_token`),
...
CREATE TABLE `request_log` (
  ...
  `client_ip_string` varchar(46) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  FULLTEXT KEY `request_log_method_host_path_normalized_route_user_agent_ref_idx` (`method`,`host`,`path`,`normalized_route`,`user_agent`,`referrer`,`error_code`,`error_message`,`internal_error_message`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `role` (
  `id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `role_type_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `account_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  PRIMARY KEY (`id`),
...
CREATE TABLE `sales_order` (
  ...
  `customer_po_number` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `note` text COLLATE utf8mb4_unicode_ci,
  `number` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `shipping_term_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sales_order_status_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sales_order_type_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `payment_term_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `production_run_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `order_discount_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `buyer_account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `sales_order_line` (
  ...
  `edi_line_item_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `line_item_number` int DEFAULT NULL,
  `product_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `item_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sales_order_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `quantity_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `unit_price_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `unit_cost_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `completed_at` datetime(3) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `scanning_station` (
  ...
  `department_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `scanning_station_type_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `label_size_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `label_type_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `shipment` (
  ...
  `carrier_option_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shipping_address_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `shipped_by_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sales_order_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `shipment_status_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `master_tracking_number` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `shipping_case` (
  ...
  `freight_weight_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `shipment_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `carrier_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
...
CREATE TABLE `shipping_term` (
  ...
  `account_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `flat_rate_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `minimum_order_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  PRIMARY KEY (`id`),
...
CREATE TABLE `shipping_term_free_shipping_rule` (
  `id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `shipping_term_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `carrier_option_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  PRIMARY KEY (`id`),
  UNIQUE KEY `shipping_term_free_shipping_rule_shipping_term_id_carrier_op_key` (`shipping_term_id`,`carrier_option_id`),
  KEY `shipping_term_free_shipping_rule_shipping_term_id_idx` (`shipping_term_id`),
...
CREATE TABLE `storage_location` (
  ...
  `storage_location_type_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `supplier_material` (
  ...
  `supplier_account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `supplier_part_number` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `supplier_description` text COLLATE utf8mb4_unicode_ci,
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `owner_account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
...
CREATE TABLE `sys_property` (
  `id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sys_property_type_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `value` int NOT NULL,
  `account_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
...
CREATE TABLE `task_leases` (
  ...
  `holder` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `transaction` (
  ...
  `amount_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `note` text COLLATE utf8mb4_unicode_ci,
  `transaction_method_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `adjustment_type_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `transaction_allocation` (
  ...
  `amount_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `invoice_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `settlement_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `note` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `unit` (
  ...
  `unit_dimension_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `unit_group` (
  ...
  `created_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updated_at` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `base_unit_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `account_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `unit_type_code` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `unit_group_unit` (
  ...
  PRIMARY KEY (`id`),
  KEY `unit_group_unit_unit_id_idx` (`unit_id`),
...
-- Dump completed on 2026-04-20 10:08:37
