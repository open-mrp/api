...
const upsertCoalescedNotification = `-- name: UpsertCoalescedNotification :execrows
INSERT INTO notification (
    id, account_id, recipient_account_user_id, category,
    source_message_id, conversation_id, title, body,
    template_key, template_params, link_resource_type, link_resource_id,
...
func (q *Queries) UpsertCoalescedNotification(ctx context.Context, arg UpsertCoalescedNotificationParams) (int64, error) {
	result, err := q.db.ExecContext(ctx, upsertCoalescedNotification,
		arg.ID,
		arg.AccountID,
		arg.RecipientAccountUserID,
		arg.Category,
