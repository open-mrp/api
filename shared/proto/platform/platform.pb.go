...
type ListRequestLogsRequest struct {
	...
	ExactMatch *bool `protobuf:"varint,12,opt,name=exact_match,json=exactMatch,proto3,oneof" json:"exact_match,omitempty"`
	// Cursor for fetching the next page, from a previous response's
	// next_cursor field. Absent on the first request.
	Cursor *string `protobuf:"bytes,13,opt,name=cursor,proto3,oneof" json:"cursor,omitempty"`
	...
	// Includes specifies which related objects to expand (e.g. "actor").
...
type RequestLogInfo struct {
	...
	NormalizedRoute string                 `protobuf:"bytes,4,opt,name=normalized_route,json=normalizedRoute,proto3" json:"normalized_route,omitempty"`
	QueryJson       *string                `protobuf:"bytes,5,opt,name=query_json,json=queryJson,proto3,oneof" json:"query_json,omitempty"`
	...
	ApiVersion      *string                `protobuf:"bytes,8,opt,name=api_version,json=apiVersion,proto3,oneof" json:"api_version,omitempty"`
	IdentityType    *string                `protobuf:"bytes,9,opt,name=identity_type,json=identityType,proto3,oneof" json:"identity_type,omitempty"`
	ClientIp        *string                `protobuf:"bytes,10,opt,name=client_ip,json=clientIp,proto3,oneof" json:"client_ip,omitempty"`
	UserAgent       *string                `protobuf:"bytes,11,opt,name=user_agent,json=userAgent,proto3,oneof" json:"user_agent,omitempty"`
	Referrer        *string                `protobuf:"bytes,12,opt,name=referrer,proto3,oneof" json:"referrer,omitempty"`
	ErrorCode       *string                `protobuf:"bytes,13,opt,name=error_code,json=errorCode,proto3,oneof" json:"error_code,omitempty"`
	...
	AccountId *string `protobuf:"bytes,20,opt,name=account_id,json=accountId,proto3,oneof" json:"account_id,omitempty"`
	// Account name resolved from target_account_id.
	AccountName *string `protobuf:"bytes,17,opt,name=account_name,json=accountName,proto3,oneof" json:"account_name,omitempty"`
	// Actor details (user or API key), varies by identity_type.
	Actor *RequestLogActor `protobuf:"bytes,18,opt,name=actor,proto3,oneof" json:"actor,omitempty"`
	// User-provided idempotency key value.
	IdempotencyKey *string `protobuf:"bytes,19,opt,name=idempotency_key,json=idempotencyKey,proto3,oneof" json:"idempotency_key,omitempty"`
	// BodyJson is the JSON-serialized request body. Absent for shielded
	// endpoints and requests with no body.
	BodyJson *string `protobuf:"bytes,21,opt,name=body_json,json=bodyJson,proto3,oneof" json:"body_json,omitempty"`
	// ResponseJson is the JSON-serialized response body. Absent for shielded
	// endpoints and responses exceeding 256 KB.
	ResponseJson  *string `protobuf:"bytes,22,opt,name=response_json,json=responseJson,proto3,oneof" json:"response_json,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RequestLogActor struct {
	...
	RedactedValue *string `protobuf:"bytes,4,opt,name=redacted_value,json=redactedValue,proto3,oneof" json:"redacted_value,omitempty"`
...
const file_platform_proto_rawDesc = "" +
	...
	"\vexact_match\x18\f \x01(\bH\tR\n" +
	"exactMatch\x88\x01\x01\x12\x1b\n" +
	"\x06cursor\x18\r \x01(\tH\n" +
	"R\x06cursor\x88\x01\x01\x12\x14\n" +
	"\x05limit\x18\x0e \x01(\x05R\x05limit\x12\x19\n" +
	"\x05query\x18\x0f \x01(\tH\vR\x05query\x88\x01\x01\x12\x1a\n" +
	"\bincludes\x18\x10 \x03(\tR\bincludesB\r\n" +
	"\v_start_dateB\v\n" +
	"\t_end_dateB\t\n" +
	"\a_methodB\x0e\n" +
	"\f_status_codeB\r\n" +
	...
	"\x04host\x18\x17 \x01(\tR\x04host\x12)\n" +
	"\x10normalized_route\x18\x04 \x01(\tR\x0fnormalizedRoute\x12\"\n" +
	"\n" +
	"query_json\x18\x05 \x01(\tH\x00R\tqueryJson\x88\x01\x01\x12\x1f\n" +
	"\vstatus_code\x18\x06 \x01(\x05R\n" +
	"statusCode\x12\x1d\n" +
	"\n" +
	"latency_us\x18\a \x01(\x03R\tlatencyUs\x12$\n" +
	"\vapi_version\x18\b \x01(\tH\x01R\n" +
	"apiVersion\x88\x01\x01\x12(\n" +
	"\ridentity_type\x18\t \x01(\tH\x02R\fidentityType\x88\x01\x01\x12 \n" +
	"\tclient_ip\x18\n" +
	" \x01(\tH\x03R\bclientIp\x88\x01\x01\x12\"\n" +
	"\n" +
	"user_agent\x18\v \x01(\tH\x04R\tuserAgent\x88\x01\x01\x12\x1f\n" +
	"\breferrer\x18\f \x01(\tH\x05R\breferrer\x88\x01\x01\x12\"\n" +
	"\n" +
	"error_code\x18\r \x01(\tH\x06R\terrorCode\x88\x01\x01\x12(\n" +
	"\rerror_message\x18\x0e \x01(\tH\aR\ferrorMessage\x88\x01\x01\x12;\n" +
	...
	"\n" +
	"account_id\x18\x14 \x01(\tH\bR\taccountId\x88\x01\x01\x12&\n" +
	"\faccount_name\x18\x11 \x01(\tH\tR\vaccountName\x88\x01\x01\x124\n" +
	"\x05actor\x18\x12 \x01(\v2\x19.platform.RequestLogActorH\n" +
	"R\x05actor\x88\x01\x01\x12,\n" +
	"\x0fidempotency_key\x18\x13 \x01(\tH\vR\x0eidempotencyKey\x88\x01\x01\x12 \n" +
	"\tbody_json\x18\x15 \x01(\tH\fR\bbodyJson\x88\x01\x01\x12(\n" +
	"\rresponse_json\x18\x16 \x01(\tH\rR\fresponseJson\x88\x01\x01B\r\n" +
	"\v_query_jsonB\x0e\n" +
	"\f_api_versionB\x10\n" +
	...
	"\x0eredacted_value\x18\x04 \x01(\tH\x02R\rredactedValue\x88\x01\x01\x12\x1c\n" +
	"\arole_id\x18\b \x01(\tH\x03R\x06roleId\x88\x01\x01\x12 \n" +
	"\trole_name\x18\x05 \x01(\tH\x04R\broleName\x88\x01\x01\x12)\n" +
	"\x0erole_type_code\x18\x06 \x01(\tH\x05R\froleTypeCode\x88\x01\x01B\a\n" +
	"\x05_nameB\b\n" +
	"\x06_emailB\x11\n" +
	"\x0f_redacted_valueB\n" +
	"\n" +
	...
	"\rGetRequestLog\x12\x1e.platform.GetRequestLogRequest\x1a\x1f.platform.GetRequestLogResponseB Z\x1eshared/proto/platform;platformb\x06proto3"
...
var file_platform_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
...
var file_platform_proto_depIdxs = []int32{
	...
	21, // 1: platform.RequestLog.occurred_at:type_name -> google.protobuf.Timestamp
	21, // 2: platform.RequestLog.created_at:type_name -> google.protobuf.Timestamp
	11, // 3: platform.CreateRequestLogRequest.request_log:type_name -> platform.RequestLog
	21, // 4: platform.ListRequestLogsRequest.start_date:type_name -> google.protobuf.Timestamp
	21, // 5: platform.ListRequestLogsRequest.end_date:type_name -> google.protobuf.Timestamp
	...
	21, // 9: platform.RequestLogInfo.occurred_at:type_name -> google.protobuf.Timestamp
	21, // 10: platform.RequestLogInfo.created_at:type_name -> google.protobuf.Timestamp
	20, // 11: platform.RequestLogInfo.actor:type_name -> platform.RequestLogActor
	1,  // 12: platform.IdempotencyService.ProcessIdempotencyKey:input_type -> platform.ProcessIdempotencyKeyRequest
	3,  // 13: platform.IdempotencyService.SetIdempotencyKeyResponse:input_type -> platform.SetIdempotencyKeyResponseRequest
	5,  // 14: platform.IdempotencyService.ReleaseIdempotencyKey:input_type -> platform.ReleaseIdempotencyKeyRequest
	7,  // 15: platform.IdempotencyService.AdvanceRecoveryPoint:input_type -> platform.AdvanceRecoveryPointRequest
	9,  // 16: platform.IdempotencyService.GetRecoveryPoint:input_type -> platform.GetRecoveryPointRequest
	12, // 17: platform.LoggingService.CreateRequestLog:input_type -> platform.CreateRequestLogRequest
	15, // 18: platform.LoggingService.ListRequestLogs:input_type -> platform.ListRequestLogsRequest
	17, // 19: platform.LoggingService.GetRequestLog:input_type -> platform.GetRequestLogRequest
	2,  // 20: platform.IdempotencyService.ProcessIdempotencyKey:output_type -> platform.ProcessIdempotencyKeyResponse
	4,  // 21: platform.IdempotencyService.SetIdempotencyKeyResponse:output_type -> platform.SetIdempotencyKeyResponseResponse
	6,  // 22: platform.IdempotencyService.ReleaseIdempotencyKey:output_type -> platform.ReleaseIdempotencyKeyResponse
	8,  // 23: platform.IdempotencyService.AdvanceRecoveryPoint:output_type -> platform.AdvanceRecoveryPointResponse
	10, // 24: platform.IdempotencyService.GetRecoveryPoint:output_type -> platform.GetRecoveryPointResponse
	13, // 25: platform.LoggingService.CreateRequestLog:output_type -> platform.CreateRequestLogResponse
	16, // 26: platform.LoggingService.ListRequestLogs:output_type -> platform.ListRequestLogsResponse
	18, // 27: platform.LoggingService.GetRequestLog:output_type -> platform.GetRequestLogResponse
