...
const (
	...
	// AgentCmdProcessEmailQueue carries inbound-email commands to the agent-service. Messages reference an S3 object containing the raw email for agent processing.
