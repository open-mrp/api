...
var typeRegistry = map[string]any{
	...
	"ScheduleLineSource":           ScheduleLineSource(""),
	"ScheduleDemandBasis":          ScheduleDemandBasis(""),
	"ScheduleGenerationSource":     ScheduleGenerationSource(""),
	"ScheduleDeviationType":        ScheduleDeviationType(""),
	"ScheduleFreezeStatus":         ScheduleFreezeStatus(""),
	"ScheduleMergeMode":            ScheduleMergeMode(""),
	"ScheduleDiffChange":           ScheduleDiffChange(""),
	"ItemLotSource":                ItemLotSource(""),
	"MachineWorkStatus":            MachineWorkStatus(""),
	"ScheduleChangeReason":         ScheduleChangeReason(""),
	"DemandOverrideReason":         DemandOverrideReason(""),
	"MachineDowntimeReasonCode":    MachineDowntimeReasonCode(""),
	"ABCClass":                     ABCClass(""),
	"AttainmentGroupBy":            AttainmentGroupBy(""),
	"AttainmentBaselineStatus":     AttainmentBaselineStatus(""),
	"SchedulePolicyConstraint":     SchedulePolicyConstraint(""),
	"SettingsStatus":               SettingsStatus(""),
	"ScheduleResourceScope":        ScheduleResourceScope(""),
	"ParticipationStatus":          ParticipationStatus(""),
	"ActivationStatus":             ActivationStatus(""),
	"DemandOverrideScope":          DemandOverrideScope(""),
	"DemandOverrideAdjustment":     DemandOverrideAdjustment(""),
	"OeeBucket":                    OeeBucket(""),
	"MachineDowntimeSource":        MachineDowntimeSource(""),
	...
	"AccountRelationRole":             AccountRelationRole(""),
	...
	"HubspotCompanyReviewAction":      HubspotCompanyReviewAction(""),
	...
	"ConversationAudience":            ConversationAudience(""),
	"ConversationWorkflowStatus":      ConversationWorkflowStatus(""),
	...
	"AgentTriggerPolicy":              AgentTriggerPolicy(""),
	...
	"MessagingGroupMemberType":        MessagingGroupMemberType(""),
	...
	"DNSRecordReason":                 DNSRecordReason(""),
	...
	"ItemReconcileType":               ItemReconcileType(""),
	"OnboardingStatus":                OnboardingStatus(""),
	"BulkResultStatus":                BulkResultStatus(""),
	"BulkResultAction":                BulkResultAction(""),
	"CarrierConnectionStatus":         CarrierConnectionStatus(""),
	"MessageStreamingState":           MessageStreamingState(""),
	"FreightExemptionType":            FreightExemptionType(""),
	"AgentToolCategory":               AgentToolCategory(""),
	"BatchLotType":                    BatchLotType(""),
	"MeasureOwnerType":                MeasureOwnerType(""),
	"ConversationAssigneeType":        ConversationAssigneeType(""),
}
