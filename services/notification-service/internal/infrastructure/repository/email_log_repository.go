...
func (r *emailLogRepoImpl) Create(ctx context.Context, emailLog *domain.EmailLog) *contracts.APIError {
...
func (r *emailLogRepoImpl) FindBySesMessageID(ctx context.Context, sesMessageID string) (*domain.EmailLog, *contracts.APIError) {
